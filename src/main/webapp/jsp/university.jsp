...
<div class="container">
    ...
    <main class="main">
        <div class="info-block">
            ...
            <p><span><spring:message code="university.rector" /></span> ${university.rector}</p>
            <p><span><spring:message code="faculty.year" /></span> ${university.establishedYear}</p>
            <p><i class="fa-solid fa-location-dot"></i> ${university.address}</p>
            <p><i class="fa-solid fa-globe"></i> <a target="_blank" href="${university.websiteUrl}">${university.websiteUrl}</a></p>
            <p><i class="fa-regular fa-envelope"></i> ${university.email}</p>
            <p><i class="fa-solid fa-phone"></i> ${university.phone}</p>
            <p>${university.description}</p>
            <a href="/faculties?university_id=${university.id}" class="info-block-details"><spring:message code="university.faculties" /></a>
            <c:choose>
                <c:when test="${role == 'ROLE_ADMIN'}">
                    <div class="info-block-buttons">
                        <a href="/updateUniversity?id=${university.id}" style="text-decoration: none;">
                            <button class="edit-button"><spring:message code="infoBlock.edit-button" /></button>
                        </a>
                        <a href="/deleteUniversity?id=${university.id}" style="text-decoration: none;">
