...
<div class="container">
    ...
    <main class="main">
        <h1 class="main-heading"><spring:message code="application-history.header"/></h1>
        <table class="main-table">
            <thead class="table-thead">
            <tr class="table-row">
                <th class="table-th"><spring:message code="listOfApplicants.table-faculty" /></th>
                ...
                <th class="table-th"><spring:message code="listOfApplicants.table-status" /></th>
            </tr>
            </thead>
            <tbody class="table-tbody">
            <c:forEach var="application" items="${applications}">
                <tr class="table-row">
                    <td class="table-td">${application.faculty.name}</td>
                    ...
                    <td class="table-td">${application.status}</td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
